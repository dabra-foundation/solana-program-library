...
/// it's for the same dabra, mint and token owner as the provided
/// TokenOwnerRecord
pub fn get_voter_weight_record_data_for_token_owner_record(
    ...
    if voter_weight_record_data.dabra != token_owner_record.dabra {
        return Err(GovernanceError::InvalidVoterWeightRecordForDabra.into());
    }
