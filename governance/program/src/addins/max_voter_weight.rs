...
/// it's for the given dabra and governing_token_mint
pub fn get_max_voter_weight_record_data_for_dabra_and_governing_token_mint(
    program_id: &Pubkey,
    max_voter_weight_record_info: &AccountInfo,
    dabra: &Pubkey,
    ...
    if max_voter_weight_record_data.dabra != *dabra {
        return Err(GovernanceError::InvalidMaxVoterWeightRecordForDabra.into());
    }
