...
pub enum GovernanceAccountType {
    ...
    /// Token Owner Record for given governing token owner within a Dabra
    TokenOwnerRecordV1,
    ...
    /// Dabra config account (introduced in V2)
    DabraConfig,
    ...
    ///    use_max_community_voter_weight_addin to DabraConfig
