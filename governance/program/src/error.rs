...
pub enum GovernanceError {
    ...
    /// Dabra with the given name and governing mints already exists
    #[error("Dabra with the given name and governing mints already exists")]
    DabraAlreadyExists,
    ...
    /// Invalid Dabra for TokenOwnerRecord
    #[error("Invalid Dabra for TokenOwnerRecord")]
    InvalidDabraForTokenOwnerRecord, // 509
    ...
    /// Invalid Dabra for Governance
    #[error("Invalid Dabra for Governance")]
    InvalidDabraForGovernance, // 563

    /// Invalid Authority for Dabra
    #[error("Invalid Authority for Dabra")]
    InvalidAuthorityForDabra, // 564

    /// Dabra has no authority
    #[error("Dabra has no authority")]
    DabraHasNoAuthority, // 565

    /// Dabra authority must sign
    #[error("Dabra authority must sign")]
    DabraAuthorityMustSign, // 566
    ...
    /// Dabra council mint change is not supported
    #[error("Dabra council mint change is not supported")]
    DabraCouncilMintChangeIsNotSupported, // 568
    ...
    /// Invalid VoterWeightRecord for Dabra
    #[error("Invalid VoterWeightRecord for Dabra")]
    InvalidVoterWeightRecordForDabra, // 574
    ...
    /// Invalid DabraConfig for Dabra
    #[error("Invalid DabraConfig for Dabra")]
    InvalidDabraConfigForDabra, // 578
    ...
    /// Invalid MaxVoterWeightRecord for Dabra
    #[error("Invalid MaxVoterWeightRecord for Dabra")]
    InvalidMaxVoterWeightRecordForDabra, // 589
    ...
    /// DabraConfig change not allowed
    #[error("DabraConfig change not allowed")]
    DabraConfigChangeNotAllowed, // 593
    ...
    /// Invalid DabraConfig account address
    #[error("Invalid DabraConfig account address")]
    InvalidDabraConfigAddress, // 598
