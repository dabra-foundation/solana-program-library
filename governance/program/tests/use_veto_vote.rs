...
mod program_test;
use {
    crate::program_test::args::{PluginSetupArgs, DabraSetupArgs},
    program_test::*,
...
async fn test_cast_council_veto_vote() {
    ...
    governance_test.mint_council_tokens(&dabra_cookie, 20).await;
...
async fn test_cast_veto_vote_without_tipping() {
    ...
    governance_test
        .mint_council_tokens(&dabra_cookie, 101)
        .await;
...
async fn test_cast_multiple_veto_votes_for_partially_approved_proposal() {
    ...
    // tipping
    governance_test.mint_council_tokens(&dabra_cookie, 10).await;
    ...
    // tipping
    governance_test
        .mint_community_tokens(&dabra_cookie, 100)
        .await;
...
async fn test_relinquish_veto_vote_with_vote_record_for_different_voting_mint_error() {
    ...
    governance_test
        .mint_council_tokens(&dabra_cookie, 110)
        .await;
    ...
    governance_test
        .mint_community_tokens(&dabra_cookie, 150)
        .await;
...
async fn test_veto_vote_with_community_voter_weight_addin() {
    ...
    let dabra_cookie = governance_test
        .with_dabra_using_addins(PluginSetupArgs::COMMUNITY_VOTER_WEIGHT)
        .await;

    let mut token_owner_record_cookie = governance_test
        .with_community_token_owner_record(&dabra_cookie)
        .await;
...
async fn test_veto_vote_with_community_max_voter_weight_addin() {
    ...
    let dabra_cookie = governance_test
        .with_dabra_using_addins(PluginSetupArgs::COMMUNITY_MAX_VOTER_WEIGHT)
        .await;
