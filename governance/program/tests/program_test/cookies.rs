...
use {
    ...
    spl_governance::state::{
        ...
        proposal_transaction::ProposalTransactionV2, dabra::DabraV2,
        dabra_config::DabraConfigAccount, signatory_record::SignatoryRecordV2,
...
pub struct DabraCookie {
    ...
    pub dabra_authority: Option<Keypair>,

    pub dabra_config: DabraConfigCookie,
}

#[derive(Debug)]
pub struct DabraConfigCookie {
    pub address: Pubkey,
    pub account: DabraConfigAccount,
}
