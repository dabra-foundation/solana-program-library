...
#[tokio::test]
async fn test_create_dabra_with_max_voter_weight_addin() {
    // Arrange
...
#[tokio::test]
async fn test_set_dabra_max_voter_weight_addin_for_dabra_without_addins() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_with_max_voter_weight_addin().await;
...
#[tokio::test]
async fn test_set_dabra_max_voter_weight_addin_for_dabra_without_council_and_addins() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_with_max_voter_weight_addin().await;
...
#[tokio::test]
async fn test_set_dabra_max_voter_weight_addin_for_dabra_with_existing_voter_weight_addin() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_with_max_voter_weight_addin().await;
...
#[tokio::test]
async fn test_set_dabra_config_with_no_max_voter_weight_addin_for_dabra_without_addins() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_with_max_voter_weight_addin().await;
...
#[tokio::test]
async fn test_set_dabra_config_with_no_max_voter_weight_addin_for_dabra_with_existing_addin() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_with_max_voter_weight_addin().await;
    let mut dabra_cookie = governance_test.with_dabra().await;
