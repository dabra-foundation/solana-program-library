...
use {
    ...
    spl_governance::{
        ...
        state::{
            dabra_config::GoverningTokenType, token_owner_record::TOKEN_OWNER_RECORD_LAYOUT_VERSION,
        },
    },
};
...
async fn test_deposit_initial_council_tokens() {
    ...
    let council_token_holding_account = dabra_cookie.council_token_holding_account.unwrap();
...
async fn test_deposit_comunity_tokens_with_cannot_deposit_dormant_tokens_error() {
    ...
    dabra_config_args.council_token_config_args.token_type = GoverningTokenType::Dormant;
