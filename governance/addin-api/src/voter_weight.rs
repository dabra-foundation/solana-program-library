...
pub enum VoterWeightAction {
    ...
    /// Create Governance within a dabra. Target: Dabra
    CreateGovernance,
...
pub struct VoterWeightRecord {
    ...
    /// The Dabra the VoterWeightRecord belongs to
    pub dabra: Pubkey,

    /// Governing Token Mint the VoterWeightRecord is associated with
    /// Note: The addin can take deposits of any tokens and is not restricted to
    /// the community or council tokens only
    // The mint here is to link the record to either community or council mint of the dabra
    ...
    /// Voter's weight
    /// The weight of the voter provided by the addin for the given dabra,
